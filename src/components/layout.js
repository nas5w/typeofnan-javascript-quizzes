...
const Layout = props => {
    ...
    return ( <
        ...
        p >
        <
        GitHubButton href = "https://github.com/nas5w/typeofnan-javascript-quizzes"
        ...
        for helping out with tasks ranging from adding questions to fixing typos.If you have time to help out, please consider { ' ' } <
